...
* clinicalStatus.coding[+] = $SCT#55561003 "Active (qualifier value)"
* verificationStatus.coding[+] = $AIVerStatus#probable
* verificationStatus.coding[+] = $SCT#2931005 "Probable diagnosis (qualifier)"
* criticality = #low
