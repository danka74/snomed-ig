...
* expansion.contains[0].designation[0].extension[designation-use-context][0].extension[role].valueCoding = #acceptable "Acceptable"
...
* expansion.contains[0].designation[0].extension[designation-use-context][1].extension[role].valueCoding = #preferred "Preferred"
...
* expansion.contains[0].designation[0].extension[designation-use-context][2].extension[role].valueCoding = #preferred "Preferred"
...
* expansion.contains[0].designation[1].extension[designation-use-context][0].extension[role].valueCoding = #preferred "Preferred"
...
* expansion.contains[0].designation[2].extension[designation-use-context][0].extension[role].valueCoding = #preferred "Preferred"
